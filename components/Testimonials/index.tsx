...
const testimonialData: Testimonial[] = [
  {
    ...
    image: "/images/testimonials/kay.png",
    star: 5,
  },
  {
    id: 2,
    name: "Enrico Lopes",
    designation: "Artista do Projeto Entre Mundos",
    content:
      "Esse projeto é realmente fascinante. A história é profunda e provoca reflexões, foi uma honra poder fazer parte da equipe de desenvolvimento.",
    image: "/images/testimonials/enrico.png",
    star: 5,
  },
  {
    id: 3,
    ...
    <section className="dark:bg-bg-color-dark bg-gray-light relative z-10 py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Confira o que os participantes do projeto dizem sobre ele"
          center
        />
